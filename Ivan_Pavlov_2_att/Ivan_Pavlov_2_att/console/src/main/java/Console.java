...
public class Console {
    ...
    public void read(SupportData supportData, Connection connection, QuaerySql quaerySql) throws Exception {
        commands();
        while (true) {
    ...
    public void readCommand(SupportData supportData, Connection connection, QuaerySql quaerySql, String command) throws Exception {
